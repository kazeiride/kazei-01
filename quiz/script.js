...
(function () {
  ...
  const PERSONALITY_TYPES = {
    explorer: {
      ...
      icon: '<img src="quiz/images/explorer.png" alt="Explorer Icon" class="icon">',
      description:
    ...
    reflector: {
      ...
      icon: '<img src="quiz/images/reflector.png" alt="Reflector Icon" class="icon">',
      description:
    ...
    creator: {
      ...
      icon: '<img src="quiz/images/creator.png" alt="Creator Icon" class="icon">',
      description:
  ...
  const TRAVELER_BLEND = {
    ...
    icon: '<img src="quiz/images/blend.png" alt="Traveler Blend Icon" class="icon">',
    description:
